...
import fr.arinonia.launcher.ui.controls.listeners.IComponentAction;
...
public class Alert {
    ...
    public Alert(UiManager uiManager, String bodyText) {
        this(uiManager, "Erreur-" + Constants.LAUNCHER_NAME, bodyText);
    }
    ...
    public void addButton(String buttonText, IComponentAction action){
        ...
        this.jfxButton.setOnMouseClicked(e -> {
            action.onClick();
        });
